  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative flex min-h-screen">
        {/* Sidebar */}
        <aside className="glass-strong sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-white/5 p-4 lg:flex">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="glass sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-white/5 px-4 sm:px-6">
            <div className="flex items-center gap-2 lg:hidden">
              <div className="gradient-brand-bg grid h-8 w-8 place-items-center rounded-lg">
            ...
            <div className="ml-auto flex items-center gap-2 sm:ml-0">
              ...
              <button className="glass grid h-10 w-10 place-items-center rounded-lg text-muted-foreground transition hover:text-foreground">
                <Bell className="h-4 w-4" />
              </button>
              <div className="gradient-brand-bg grid h-10 w-10 place-items-center rounded-full text-sm font-semibold text-white">
                AN
              </div>
            </div>
          </header>
